...
- Root/sudo access for raw socket operations`,
      ...
      },
      {
        ...
        content: `List available network interfaces. Look for interfaces that are UP and have a cable connected.`,
        command: 'ip link show',
        expected: 'List of interfaces with state UP',
      },
      {
        title: 'Start the Reflector',
        content: `On the far-end device (or a second port), start the reflector. This will echo back all received test traffic.`,
      ...
      {
        title: 'View Results',
        content: `The test will display results showing maximum throughput for each frame size. Congratulations - you have completed your first network test!`,
...
- DPDK: Maximum performance (15-40+ Mpps)`,
      ...
      },
      {
        ...
        content: `For maximum performance, use AF_XDP mode. This requires a modern kernel with XDP support.`,
...
3. Try AF_XDP mode for better performance`,
      ...
      },
      {
        ...
        content: `AF_XDP requires kernel 5.x+ and driver support. Fall back to AF_PACKET if needed.`,
        command: 'uname -r',
