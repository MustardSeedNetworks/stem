 ...
 */
/**
 * Stats — generated from the Go struct in internal/api; refresh with `make schema` after struct changes.
 */
export interface Stats {
  ...
  currentMbps: number;
  uptime: number;
  testStatus: 'idle' | 'starting' | 'running' | 'completed' | 'error' | 'stopped' | 'cancelled';
