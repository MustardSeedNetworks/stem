...
export const defaultTSNConfig: TSNConfig = {
  ...
  maxJitterNs: 100000, // 100µs
  requirePTPSync: true,
  maxSyncOffsetNs: 1000, // 1µs
  ptpEnabled: true,
...
/** Common cycle times */
const CYCLE_TIME_OPTIONS = [
  { value: 125000, label: '125 µs' },
  { value: 250000, label: '250 µs' },
  { value: 500000, label: '500 µs' },
...
export function TSNConfigForm({
  ...
  const updateConfig = (updates: Partial<TSNConfig>) => {
      ...
      <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig({ maxLatencyNs: Number(e.target.value) * 1000 })}
                className="mt-1 w-full"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig({ maxJitterNs: Number(e.target.value) * 1000 })}
                className="mt-1 w-full"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => updateConfig({ ptpEnabled: e.target.checked })}
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => updateConfig({ requirePTPSync: e.target.checked })}
                className="rounded border-[var(--color-surface-border)]"
              />
          ...
          {config.ptpEnabled && (
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig({ maxSyncOffsetNs: Number(e.target.value) })}
                className="mt-1 w-full"
              />
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => updateConfig({ preemptionEnabled: e.target.checked })}
                className="rounded border-[var(--color-surface-border)]"
              />
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateConfig({ cycleTimeNs: Number(e.target.value) })}
                  className="mt-1 w-full"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateConfig({ trafficClass: Number(e.target.value) })}
                  className="mt-1 w-full"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig({ numTrafficClasses: Number(e.target.value) })}
                className="mt-1 w-full"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => updateConfig({ baseTimeNs: Number(e.target.value) })}
                className="mt-1 w-full"
              />
            </div>
          </div>
        ...
        <div className="p-3 rounded-lg bg-[var(--color-surface-base)] border border-[var(--color-surface-border)]">
          ...
          <div className="text-xs text-[var(--color-text-muted)] space-y-1">
            ...
            <div>
              Timing: ≤{formatNs(config.maxLatencyNs)} latency | ≤{formatNs(config.maxJitterNs)}{' '}
              jitter
            </div>
            <div>
