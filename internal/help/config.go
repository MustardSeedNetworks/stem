		...
		Options: []ConfigOption{
			{
				...
				TechDesc:   "Use AF_XDP sockets for high-performance packet I/O. Faster than AF_PACKET. Requires Linux 5.0+.",
		...
		Options: []ConfigOption{
			{
				...
				TechDesc:   "Signed license token in format MSN1.<payload>.<signature>. Determines available features (Reflector, Professional tiers).",
