...
//
// Lifted from the seed project (internal/truststore); keep in sync. The
// implementation is intentionally small: it shells out to the platform
...
// stem in control of error reporting and avoids pulling in mkcert's
...
// invoke `stem install-ca` under sudo rather than re-implementing
